  ...
  company: z
    .object({
      ...
      headcountMin: z
        ...
        .max(500000, "Min must not be greater than 10,000")
        .int()
        .default(1),
      headcountMax: z
        .number({ invalid_type_error: "Max must be a number" })
        .min(1, "Max must be greater than 0")
        .max(500000, "Max must not be greater than 10,000")
        .int()
        .default(10000),
      orgSize: z
        .object({
          engineeringMin: z
            .number({ invalid_type_error: "Min must be a number" })
            .min(1, "Min must be greater than 0")
            .max(50000, "Min must not be greater than 2000")
            .int()
            .default(1),
          engineeringMax: z
            .number({ invalid_type_error: "Max must be a number" })
            .min(1, "Max must be greater than 0")
            .max(50000, "Max must not be greater than 2000")
            .int()
            .default(500),
        })
