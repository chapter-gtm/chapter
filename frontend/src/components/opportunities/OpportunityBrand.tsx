      ...
      <div className="flex-1 overflow-y-auto rounded-xl">
        <div className="flex flex-row gap-y-1 overflow-visible py-2">
          <div className="flex flex-row gap-x-3 items-center">
            ...
            <div className="flex flex-row items-first justify-first gap-x-3">
                ...
                <div className="flex flex-inline max-h-7 gap-x-1.5 items-center justify-center text-xs text-zinc-700 dark:text-zinc-200">
                  ...
                  {opportunity.company?.discordUrl ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="gap-x-2 bg-background hover:bg-background/50 dark:bg-popover h-6 w-7 justify-center rounded-md dark:hover:bg-card flex items-center"
                    >
                      <span>
                        <svg
                          width="17"
