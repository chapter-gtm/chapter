...
def schema_downgrades() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["company_id"], ["company.id"], name="fk_company_person_relation_company_id_company", ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["person_id"], ["person.id"], name="fk_company_person_relation_person_id_person", ondelete="CASCADE"
        ),
