...
def schema_upgrades() -> None:
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTimeUTC(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
            ["role_id"], ["role.id"], name=op.f("fk_user_account_role_role_id_role"), ondelete="cascade"
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["user_account.id"], name=op.f("fk_user_account_role_user_id_user_account"), ondelete="cascade"
        ),
