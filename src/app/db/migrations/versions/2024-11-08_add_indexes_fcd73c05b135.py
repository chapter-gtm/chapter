...
def schema_upgrades() -> None:
    ...
    with op.batch_alter_table('opportunity_job_post_relation', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_opportunity_job_post_relation_opportunity_id'), ['opportunity_id'], unique=False)

    with op.batch_alter_table('opportunity_person_relation', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_opportunity_person_relation_opportunity_id'), ['opportunity_id'], unique=False)
